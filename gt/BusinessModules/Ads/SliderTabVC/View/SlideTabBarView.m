...
-(CGFloat) tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [SlideBarCell cellHeightWithModelWithType:_currentPage WithModel:_tabTitles];
}

-(UITableViewCell *)tableView:tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    SlideBarCell *cell = [SlideBarCell cellWith:tableView];
...
//        cell.tipTitle.text = _dataSource[_currentPage][indexPath.row];//_currentPage%2
        [cell richElementsInCellWithType:_currentPage WithModel:_tabTitles];
