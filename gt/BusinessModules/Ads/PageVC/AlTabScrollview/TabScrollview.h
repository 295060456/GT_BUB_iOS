...
//#define kTabScrollViewHeight  73

#define kTagStringWidth  25
#define kTagLabTextFontNormal  [UIFont systemFontOfSize:14]
#define kTagLabTextFontSelected  [UIFont boldSystemFontOfSize:14]
#define kTagLabTextColorNormal  HEXCOLOR(0x232630)
#define kTagLabTextColorSelected  [YBGeneralColor themeColor]

#define kTagLineheight 3 //默认标记线高度
#define kTagLineColor [YBGeneralColor themeColor]  //默认标记颜色
