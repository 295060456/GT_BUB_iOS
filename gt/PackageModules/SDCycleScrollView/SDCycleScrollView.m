...
@property (nonatomic, strong) BannerPagePointView* pointView;
...
+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame placeholderImage:(UIImage *)placeholderImage
{
    ...
    cycleScrollView.pointView =  [[BannerPagePointView alloc] initWithFrame:CGRectMake(0, frame.size.height - 12 *SCALING_RATIO, frame.size.width-12*SCALING_RATIO, 10*SCALING_RATIO) andPosition:PositionRight andPointColor:HEXCOLOR(0xf7f7f7)];
    [cycleScrollView addSubview:cycleScrollView.pointView];
    return cycleScrollView;
}
...
- (void)setImageURLStringsGroup:(NSArray *)imageURLStringsGroup
{
    ...
    self.pointView.pointCount = imageURLStringsGroup.count;
    self.pointView.choosePointCount = 0;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if ([self.pageControl isKindOfClass:[TAPageControl class]]) {
        ...
        UIPageControl *pageControl = (UIPageControl *)_pageControl;
        pageControl.currentPage = indexOnPageControl;
        self.pointView.choosePointCount = indexOnPageControl;
    }
}
